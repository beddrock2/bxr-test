...
const downloadGameDetails = {
	...
	"Call of Duty: Modern Warfare (2019)": {
		steamId: "2000950",
		genre: "First-person shooter", icon: "M", version: "Steam edition", size: "125 GB", release: "Mar 8, 2023", posted: "Jun 27, 2025", credit: "Activision", developer: "Infinity Ward", publisher: "Activision", proton: "Gold", reviews: "Mixed", about: "A gritty reimagining of the Modern Warfare series with intense single-player missions and multiplayer combat."
	},
	"Call of Duty: Modern Warfare II": {
		steamId: "1938090",
		genre: "First-person shooter", icon: "M", version: "Steam edition", size: "125 GB", release: "Oct 27, 2022", posted: "Jun 28, 2025", credit: "Activision", developer: "Infinity Ward", publisher: "Activision", proton: "Gold", reviews: "Mixed", about: "Task Force 141 returns in a worldwide campaign of covert operations, tactical combat, and high-stakes action."
	},
	"Call of Duty: Modern Warfare III": {
		steamId: "2519060",
		genre: "First-person shooter", icon: "M", version: "Steam edition", size: "125 GB", release: "Nov 10, 2023", posted: "Jun 29, 2025", credit: "Activision", developer: "Sledgehammer Games", publisher: "Activision", proton: "Gold", reviews: "Mixed", about: "Captain Price and Task Force 141 face the ultimate threat in a campaign of tactical combat and global action."
	},
	"Subnautica": {
		steamId: "264710",
		genre: "Underwater survival", icon: "S", version: "Steam edition", size: "15 GB", release: "Jan 23, 2018", posted: "Jul 1, 2025", developer: "Unknown Worlds Entertainment", publisher: "Unknown Worlds Entertainment", proton: "Platinum", reviews: "Overwhelmingly Positive", about: "Descend into the depths of an alien ocean planet and explore, craft, build, and survive."
	},
	"Cyberpunk 2077": {
		steamId: "1091500",
		genre: "Open-world RPG", icon: "C", version: "Steam edition", size: "70 GB", release: "Dec 10, 2020", posted: "Jul 2, 2025", developer: "CD PROJEKT RED", publisher: "CD PROJEKT RED", proton: "Platinum", reviews: "Very Positive", about: "Enter the open world of Night City, a megalopolis obsessed with power, glamour, and body modification."
	},
	"The Witcher 3: Wild Hunt": {
		steamId: "292030",
		genre: "Open-world RPG", icon: "W", version: "Complete Edition", size: "50 GB", release: "May 18, 2015", posted: "Jul 3, 2025", developer: "CD PROJEKT RED", publisher: "CD PROJEKT RED", proton: "Platinum", reviews: "Overwhelmingly Positive", about: "Become a professional monster slayer and explore a vast fantasy world full of choices and consequences."
	},
	"Grand Theft Auto V": {
		steamId: "271590",
		genre: "Open-world action", icon: "G", version: "Legacy edition", size: "110 GB", release: "Apr 14, 2015", posted: "Jul 4, 2025", developer: "Rockstar North", publisher: "Rockstar Games", proton: "Gold", reviews: "Very Positive", about: "Explore Los Santos and Blaine County in the biggest, most dynamic open world yet created by Rockstar Games."
	},
	"ELDEN RING": {
		steamId: "1245620",
		genre: "Action RPG", icon: "E", version: "Steam edition", size: "60 GB", release: "Feb 25, 2022", posted: "Jul 5, 2025", developer: "FromSoftware, Inc.", publisher: "Bandai Namco Entertainment", proton: "Platinum", reviews: "Very Positive", about: "Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord."
	},
	"Hogwarts Legacy": {
		steamId: "990080",
		genre: "Open-world action RPG", icon: "H", version: "Steam edition", size: "85 GB", release: "Feb 10, 2023", posted: "Jul 6, 2025", developer: "Avalanche Software", publisher: "Warner Bros. Games", proton: "Gold", reviews: "Very Positive", about: "Experience the life of a student as you live the unwritten and embark on a journey to uncover a hidden truth."
	},
	"Dying Light": {
		steamId: "239140",
		genre: "Zombie survival action", icon: "D", version: "Steam edition", size: "40 GB", release: "Jan 26, 2015", posted: "Jul 7, 2025", developer: "Techland", publisher: "Techland", proton: "Platinum", reviews: "Very Positive", about: "Survive in a city overrun by a vicious epidemic where the infected grow more aggressive after sunset."
	},
	"Valheim": {
		steamId: "892970",
			...
			dangerouslySetInnerHTML: {
				__html: `<style>
                  ...
                  <div id="catalog-view"><div class="catalog-shell"><p class="kicker">Library / Select a game</p><h1>Choose your next adventure.</h1><p class="intro">Browse the collection, hover a cover to preview it, then open a game for its media, requirements, download mirrors, and release information.</p><div class="catalog-tools"><label class="search"><span>⌕</span><input type="search" placeholder="Search games"></label><div class="filters"><button type="button">All games</button><button type="button">Action</button><button type="button">Adventure</button><button type="button">Horror</button><button type="button">Recently added</button></div></div><div class="poster-grid">
					...
					<button class="poster-card" type="button" data-open-details data-game="Call of Duty: Modern Warfare II" style="--cover:url('https://cdn.akamai.steamstatic.com/steam/apps/1938090/library_600x900.jpg')"><span class="tag">First-person shooter</span><span class="cover"></span><span class="poster-copy"><h2>Call of Duty: Modern Warfare II</h2><p>Join Task Force 141 in a worldwide campaign of covert operations.</p></span><span class="view-label">View game →</span></button>
					<button class="poster-card" type="button" data-open-details data-game="Call of Duty: Modern Warfare III" style="--cover:url('https://cdn.akamai.steamstatic.com/steam/apps/2519060/library_600x900.jpg')"><span class="tag">First-person shooter</span><span class="cover"></span><span class="poster-copy"><h2>Call of Duty: Modern Warfare III</h2><p>Captain Price and Task Force 141 face the ultimate global threat.</p></span><span class="view-label">View game →</span></button>
					<button class="poster-card" type="button" data-open-details data-game="Subnautica" style="--cover:url('https://cdn.akamai.steamstatic.com/steam/apps/264710/library_600x900.jpg')"><span class="tag">Underwater survival</span><span class="cover"></span><span class="poster-copy"><h2>Subnautica</h2><p>Descend into an alien ocean planet and survive its dangerous depths.</p></span><span class="view-label">View game →</span></button>
					<button class="poster-card" type="button" data-open-details data-game="Cyberpunk 2077" style="--cover:url('https://cdn.akamai.steamstatic.com/steam/apps/1091500/library_600x900.jpg')"><span class="tag">Open-world RPG</span><span class="cover"></span><span class="poster-copy"><h2>Cyberpunk 2077</h2><p>Enter Night City, a megalopolis obsessed with power and body modification.</p></span><span class="view-label">View game →</span></button>
					<button class="poster-card" type="button" data-open-details data-game="The Witcher 3: Wild Hunt" style="--cover:url('https://cdn.akamai.steamstatic.com/steam/apps/292030/library_600x900.jpg')"><span class="tag">Open-world RPG</span><span class="cover"></span><span class="poster-copy"><h2>The Witcher 3: Wild Hunt</h2><p>Become a professional monster slayer in a world of choices and consequences.</p></span><span class="view-label">View game →</span></button>
					...
					<button class="poster-card" type="button" data-open-details data-game="ELDEN RING" style="--cover:url('https://cdn.akamai.steamstatic.com/steam/apps/1245620/library_600x900.jpg')"><span class="tag">Action RPG</span><span class="cover"></span><span class="poster-copy"><h2>ELDEN RING</h2><p>Become an Elden Lord in a vast fantasy world from FromSoftware.</p></span><span class="view-label">View game →</span></button>
